      ...
      <CommonWrapper>
        ...
        <div className="my-[100px] max-[767px]:my-[70px] ">
          ...
          <ul className="list-disc list-outside pl-6 space-y-3">
            {[
              "bonus.terms.firstBonus.content",
              "bonus.terms.secondBonus.content",
              "bonus.terms.thirdBonus.content",
              "bonus.terms.fourthBonus.content",
              "bonus.terms.fifthBonus.content",
            ].map((point, index) => (
              <li
                key={index}
