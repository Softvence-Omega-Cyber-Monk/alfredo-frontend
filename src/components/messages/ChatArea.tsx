  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {isBlockedByMe && (
          <div className="bg-red-50 border-y border-red-100 p-2.5 text-center text-xs text-red-700 font-semibold shadow-inner">
            You have blocked this user. Unblock to resume messaging.
          </div>
        )}
        {isBlockedByThem && (
          <div className="bg-slate-100 border-y border-slate-200 p-2.5 text-center text-xs text-slate-600 font-semibold shadow-inner">
        ...
        {isAttachmentLocked && !isBlocked && (
          <div className="bg-amber-50 border-y border-amber-100 p-2 text-center text-[11px] text-amber-700 flex items-center justify-center gap-1 font-medium">
        ...
        {/* Input area */}
        <div className="flex items-center p-3 bg-white border-t border-slate-100 gap-2">
          {/* File Input (Hidden) */}
          <input
            type="file"
            ref={fileInputRef}
