          ...
          <div className="flex flex-col md:flex-row max-w-[1000px] h-full mx-auto items-center gap-12 px-4 py-10 md:py-0">
            ...
            <div className="flex flex-col gap-6 md:gap-10 text-white w-full md:w-auto">
              ...
              <div className="w-full">
                ...
                <div className="relative mt-3 flex flex-col md:flex-row items-start md:items-center gap-4">
                  <input
                    type="email"
                    value={email}
                  ...
                  <ReusableButton
                    ...
                    disabled={loading}
                    className="w-full md:w-auto h-[52px] flex justify-center items-center"
                  >
                ...
                {/* Disclaimer  */}
                <p className="mt-5 text-xs text-white">{t("disclaimer")}</p>
              </div>
            </div>
          </div>
        </div>
